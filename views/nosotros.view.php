<?php require 'header.php'; ?>
    ...
    <section class="center col-12 col-md-8 d-flex flex-column align-items-center order-0 order-md-1">
        <div class="nosotros galeria my-3 mx-0 mx-md-2">
            <div class="nosotros p-1">
                <p class="fs-3 fw-bolder">Historia...</p>
                <p class="d-none d-md-block lh-base fs-5 mx-2" id="bio">All started back in March 2014. There was a need for a choir 
                ...
                <p class="d-block d-md-none lh-sm" id="bio">All started back in March 2014. There was a need for a choir 
                    at the San José chapel but there was no one to take that place to sing 
                    the Masses that were celebrated in there. So, one day, when the San José's 
                    feasts were taking place, must of the current members sat down along with 
                    others current ex members and decided we would be taking that option of 
