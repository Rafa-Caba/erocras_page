<?php require 'header.php'; ?>
    ...
    <section class="center col-12 col-md-8 d-flex flex-column align-items-center order-0 order-md-1">
        <div class="miembros w-100">
            <p class="text-center fw-bolder fs-1">- Integrantes -</p>
                ...
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                        ...
                        <figcaption class="trasera">
                            ...
                            <hr>
                            <p class="fs-4 lh-sm">Guitarra y voz</p>
                        </figcaption>
                    </figure>

                    <p class="text-center fw-bolder">Rafael Cabanillas</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                        ...
                        <figcaption class="trasera">
                            ...
                            <hr>
                            <p class="fs-4 lh-sm">Voz</p>
                        </figcaption>
                    </figure>

                    <p class="text-center fw-bolder">Carito Dominguez</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                        ...
                        <figcaption class="trasera">
                            ...
                            <hr>
                            <p class="fs-4 lh-sm">Voz y pandero</p>
                        </figcaption>
                    </figure>
                    
                    <p class="text-center fw-bolder">Lupita Dominguez</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">Mariana Herrera</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">Angel Dominguez</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                        ...
                        <figcaption class="trasera">
                            ...
                            <hr>
                            <p class="fs-4 lh-sm">Mandolina y voz</p>
                        </figcaption>
                    </figure>

                    <p class="text-center fw-bolder">Daniela Marquez</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">Alan Piña</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">María Cisneros</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">Daniel Glez</p>
                </div>
                <div class="contenedor_tarjeta">
                    <figure class="position-relative m-0">
                    ...
                    <p class="text-center fw-bolder">Antonio Arias</p>
                </div>
            </div>
        </div>
    </section>
